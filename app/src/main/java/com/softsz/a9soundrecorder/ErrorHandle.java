...
class ErrorHandle {
    ...
    public static void showErrorInfo(Activity activity, int errorCode) {
        ...
        Log.e(TAG, "<showErrorInfo> errorCode = " + errorCode);
        switch (errorCode) {
        ...
        case ERROR_STORAGE_FULL_WHEN_RECORD:
            ...
            break;
        default:
            Log.e(TAG, "<showErrorInfo> error code is out of range");
            break;
        }
    }
    ...
    public static void showErrorInfoInToast(Context context, int errorCode) {
        ...
        Log.e(TAG, "<showErrorInfoInToast> errorCode = " + errorCode);
        switch (errorCode) {
        case ERROR_ACCESSING_DB_FAILED_WHEN_QUERY:
        ...
        case ERROR_STORAGE_FULL_WHEN_RECORD:
            ...
            break;
        default:
            Log.e(TAG, "<showErrorInfoInToast> error code is out of range");
            break;
        }
    }
    ...
    private static void removeOldErrorDialog(Activity activity) {
        ...
        Log.i(TAG, "<removeOldErrorDialog> oldFragment = " + oldFragment);
        if (null != oldFragment) {
            oldFragment.dismissAllowingStateLoss();
            Log.i(TAG, "<removeOldErrorDialog> remove oldFragment");
        }
    }
